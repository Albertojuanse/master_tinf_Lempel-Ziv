...
while 1
    ...
    next_size_dictionary = pointer_dictionary + 1;
    ...
    % before use it.
    if i_entry_retrieved > pointer_dictionary
        pointer_dictionary = pointer_dictionary + 1;
        dictionary{pointer_dictionary,1} = [entry_retrieved];
        fwrite(output_file_id, [output; entry_retrieved],'ubit8');
    else
        entry_found = dictionary{i_entry_retrieved};
        pointer_dictionary = pointer_dictionary + 1;
        dictionary{pointer_dictionary,1} = [entry_found entry_retrieved];
    ...
    next_size_dictionary = pointer_dictionary;
    next_size_dictionary_bin = dec2bin(next_size_dictionary);
    next_num_bits = size(next_size_dictionary_bin,2);
